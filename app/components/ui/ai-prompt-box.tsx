  ...
  <DialogPortal>
    ...
    >
      ...
      <DialogPrimitive.Close className="absolute right-4 top-4 z-10 rounded-full bg-secondary/80 p-2 hover:bg-secondary transition-all">
        <X className="h-5 w-5 text-foreground hover:text-foreground/80" />
              ...
              >
                <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
                  <motion.div
                    ...
                    transition={{ type: "spring", stiffness: 260, damping: 25 }}
                  >
                    <BrainCog className={cn("w-4 h-4", showThink ? "text-accent-foreground" : "text-inherit")} />
                  </motion.div>
                </div>
                <AnimatePresence>
                  {showThink && (
                    <motion.span
                      ...
                      exit={{ width: 0, opacity: 0 }}
                      transition={{ duration: 0.2 }}
                      className="text-xs overflow-hidden whitespace-nowrap text-accent-foreground flex-shrink-0"
                    >
                      Think
                    </motion.span>
                  )}
