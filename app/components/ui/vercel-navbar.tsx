      ...
      <div className="flex items-center justify-between w-full  mx-auto max-w-7xl">
        ...
        <div className="flex gap-2 items-center">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-64 p-3 rounded-xl" align="end">
              <div className="p-2">
                <h1 className="font-semibold text-foreground">Ali Imam</h1>
  ...
  return (
    <li {...props} className="group">
      <NavigationMenuLink asChild>
        <Link to={href}>
          <div className="flex gap-3 items-start rounded-md p-2 transition-all group-hover:bg-foreground">
            <div className="border rounded-sm p-2 transition-all group-hover:bg-foreground group-hover:text-background group-hover:scale-105">
                {icon}
            </div>
            <div>
              <div className="text-sm font-medium leading-none transition-all group-hover:text-background">{title}</div>
              <p className="text-muted-foreground line-clamp-2 pt-1 text-xs leading-snug transition-all group-hover:text-background/80">
                {children}
              </p>
            </div>
          </div>
    ...
    >
      {themes.map(({ key, icon: Icon, label }) => {
        ...
        return (
          <button
            aria-label={label}
            className="relative h-5 w-6 rounded-full flex items-center justify-center"
            key={key}
